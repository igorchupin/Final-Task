...
public class CreateAccountIncorrectMail implements ICreateAccountStrategy {
    ...
    public CreateAccountIncorrectMail() throws IOException {
        driver = SingleDriver.getSingleDriverInstance().getDriver();
        randomMAil = generateMailName();
    }
